...
meta:
	ADDON_NAME = ofxPlottable
	ADDON_DESCRIPTION = Layer to draw vector graphics on for export to SVG for a pen plotter
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon" "plotter" "vector"
	ADDON_URL = http://github.com/smeyfroi/ofxPlottable
